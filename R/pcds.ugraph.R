...
#' Proportional-Edge PCDs and Central Similarity PCDs (\insertCite{ceyhan:Phd-thesis,
#' ceyhan:arc-density-PE,ceyhan:arc-density-CS;textual}{pcds.ugraph}).
#'
#' The graph invariant used in testing spatial point data are the edge density of the underlying graphs of the PCDs
...
#' The AS-PCD and CS-PCD related tools are provided for 1D and 2D data; PE-PCD related tools are provided for 1D-3D data.
#'
...
#' Contains the functions used in AS-PCD construction and computation of edge density of the corresponding underlying graph.
#'
#' @section Proportional-Edge PCD Functions:
#' Contains the functions used in PE-PCD construction and computation of edge density of the corresponding underlying graph.
#'
#' @section Central-Similarity PCD Functions:
#' Contains the functions used in CS-PCD construction and computation of edge density of the corresponding underlying graph.
#'
#' @references
#' \insertAllCited{}
#'
